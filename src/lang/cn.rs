...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ("Status", "状态"),
        ("Your Desktop", "黄荷远控"),
        ("desk_tip", "by 黄荷 于2024年12月31日 下关"),
        ("Password", "密码"),
        ("Ready", "已成功连接黄荷远控服务器..."),
        ("Established", "已建立"),
        ("connecting_status", "正在接入 黄荷远控服务器..."),
        ("Enable service", "允许服务"),
        ("Start service", "启动被控"),
        ("Service is running", "被控运行中..."),
        ("Service is not running", "被控未运行"),
        ("not_ready_status", "未成功连接黄荷远控服务器，请检查网络连接"),
        ...
        ("Website", "网站"),
        ("About", "远控世界，唯爱何思，远控黄荷！"),
        ("Slogan_tip", "远控世界，唯爱何思，远控黄荷！"),
        ("Privacy Statement", "远控世界，唯爱何思，远控黄荷！"),
        ("Mute", "静音"),
        ("Build Date", "构建日期"),
        ("Version", "版本"),
        ("Home", "主页"),
        ...
        ("Set Password", "设置密码"),
        ("OS Password", "操作系统密码"),
        ("install_tip", "你正在运行未安装版本，由于 UAC 限制，作为被控端，会在某些情况下无法控制鼠标键盘，或者录制屏幕，请点击下面的按钮将 黄荷远控 安装到系统，从而规避上述问题。"),
        ("Click to upgrade", "点击这里升级"),
        ("Click to download", "点击这里下载"),
        ("Click to update", "点击这里更新"),
        ("Configure", "配置"),
        ("config_acc", "为了能够远程控制你的桌面, 请给予 黄荷远控 \"辅助功能\" 权限。"),
        ("config_screen", "为了能够远程访问你的桌面, 请给予 黄荷远控 \"屏幕录制\" 权限。"),
        ("Installing ...", "安装中..."),
        ("Install", "安装"),
        ("Installation", "安装"),
        ...
        ("android_input_permission_tip1", "为了让远程设备通过鼠标或触屏控制您的安卓设备，你需要允许 黄荷远控 使用\"无障碍\"服务。"),
        ("android_input_permission_tip2", "请在接下来的系统设置页面里，找到并进入 [已安装的服务] 页面，将 [黄荷远控 Input] 服务开启。"),
        ("android_new_connection_tip", "收到新的连接控制请求，对方想要控制你当前的设备。"),
        ("android_service_will_start_tip", "开启录屏权限将自动开启服务，允许其他设备向此设备请求建立连接。"),
        ("android_stop_service_tip", "关闭被控将自动关闭所有已建立的连接。"),
        ("android_version_audio_tip", "当前安卓版本不支持音频录制，请升级至安卓 10 或更高。"),
        ("android_start_service_tip", "点击启动被控或启用屏幕捕获权限，即可启动屏幕共享服务"),
        ...
        ("Turned off", "退出"),
        ("Language", "语言"),
        ("Keep RustDesk background service", "保持 黄荷远控 后台服务"),
        ("Ignore Battery Optimizations", "忽略电池优化"),
        ("android_open_battery_optimizations_tip", "如需关闭此功能，请在接下来的 黄荷远控 应用设置页面中，找到并进入 [电源] 页面，取消勾选 [不受限制]"),
        ("Start on boot", "开机自启动"),
        ...
        ("config_input", "为了能够通过键盘控制远程桌面, 请给予 黄荷远控 \"输入监控\" 权限。"),
        ("config_microphone", "为了支持通过麦克风进行音频传输，请给予 黄荷远控 \"录音\"权限。"),
        ...
        ("still_click_uac_tip", "依然需要被控端用户在运行 黄荷远控 的 UAC 窗口点击确认。"),
        ...
        ("verify_rustdesk_password_tip", "验证 黄荷远控 密码"),
        ...
        ("{} sessions", "{} 个会话"),
        ("scam_title", "HSHE重要提醒："),
        ("scam_text1", "请你确认要运行远程另一设备控制你的设备吗！"),
        ("scam_text2", "你确认后：你的设备将被远程另一设备控制！"),
        ...
        ("selinux_tip", "SELinux 处于启用状态，黄荷远控 可能无法作为被控正常运行。"),
        ("Change view", "更改视图"),
        ("Big tiles", "大磁贴"),
        ("Small tiles", "小磁贴"),
        ("List", "列表"),
        ...
        ("allow-only-conn-window-open-tip", "仅当 黄荷远控 窗口打开时允许连接"),
        ...
        ("Floating window", "悬浮窗"),
        ("floating_window_tip", "有助于保持 黄荷远控 后台服务"),
